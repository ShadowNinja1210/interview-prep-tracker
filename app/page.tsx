  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">SDE-2 Interview Preparation Tracker</h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          AI-powered coaching system to track, analyze, and optimize your interview preparation with strict, data-driven
          insights.
        </p>
      </div>
